...
void viewEvent(Calendar calendar){
    ...
    cout<<"You chose start year: "<<calendar.getStartYear()<<" and end year: "<<calendar.getEndYear()<<" in the beginning of this run of the program"<<endl;
	cout<<"You may have chosen different years in previous runs"<<endl;

	cout<<endl<<"Please enter the year: "<<endl;
//	inputYear = inRange(calendar.getStartYear(),calendar.getEndYear());
    inputYear = inRange(1970, 2030);
	...
	inputDay = inRange(1, daysInMonth);
